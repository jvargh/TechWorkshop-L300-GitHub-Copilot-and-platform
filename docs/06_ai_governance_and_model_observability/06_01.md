---
title: '1. Enforce identity-only access to Microsoft Foundry'
layout: default
nav_order: 1
...
Microsoft Foundry supports multiple authentication modes, including traditional API keys and modern Microsoft Entra ID (managed identity + OAuth).
...
- [Configure authentication for Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/configure-authentication?tabs=azure-cli){:target="_blank"}
...
- [Role-based access control (RBAC) for Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/rbac-azure-ai-foundry){:target="_blank"}
